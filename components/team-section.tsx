                ...
                <div className="relative h-80 overflow-hidden">
                  <div
                    className={`absolute inset-0 bg-cover transition-transform duration-500 group-hover:scale-110 group-hover:rotate-2 ${
                      index === 1 ? "bg-[position:center_10%]" : index === 3 ? "bg-[position:center_20%]" : "bg-center"
                    }`}
              ...
              <div className="relative h-96">
                <div
                  className={`absolute inset-0 bg-cover ${
                    currentIndex === 1 ? "bg-[position:center_10%]" : currentIndex === 3 ? "bg-[position:center_30%]" : "bg-center"
                  }`}
